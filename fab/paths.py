...
logger.info("METAPHOR_DIR:          %s" % os.environ["METAPHOR_DIR"])
logger.info("HENRY_DIR:             %s" % os.environ["HENRY_DIR"])
logger.info("BOXER_DIR:             %s" % os.environ["BOXER_DIR"])
logger.info("TMP_DIR:               %s" % os.environ["TMP_DIR"])
logger.info("GUROBI_HOME:           %s" % os.environ["GUROBI_HOME"])
logger.info("GRB_LICENSE_FILE:      %s" % os.environ["GRB_LICENSE_FILE"])
logger.info("CPLUS_INCLUDE_PATH:    %s" % os.environ["CPLUS_INCLUDE_PATH"])
logger.info("PATH:                  %s" % os.environ["PATH"])
logger.info("LD_LIBRARY_PATH:       %s" % os.environ["LD_LIBRARY_PATH"])
logger.info("LIBRARY_PATH:          %s" % os.environ["LIBRARY_PATH"])
